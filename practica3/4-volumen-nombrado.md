...
```
docker run -d --name client-postgres --publish published=9501,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=cantu08@postgres.com --network net-drupal dpage/pgadmin4
```

### Usar el cliente postgres para conectarse al servidor postgres, para la conexión usar el nombre del servidor en lugar de la dirección IP.
![screen](imagenes/pgadmin.png)
...
![screen](imagenes/configurarDrupal.png)

_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

![screen](imagenes/diagrama.png)
